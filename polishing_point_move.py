...
class PickAndPlace(object):
    ...
    def _approach(self, pose):
        ...
        rospy.sleep(0.5)
        #移动到目标之上，高度为  self._hover_distance=0.15  米
...
def main():
    ...
    the loop.
    这是一个 highly 脚本和调整的演示程序。目标的位置是已知的并且动作是开环的。
    这是一个初级版本；baxter 将最终误选或丢弃块。您可以通过添加感知和反馈来改善这个演示循环。
   ...
   # rospy.on_shutdown(delete_gazebo_models)
    ...
    limb = 'right'                         #----------------------定义使用右臂
    hover_distance = 0.15 # meters         #----------------------悬停距离0.15m
    ...
    starting_joint_angles = {'right_w0': -0.6699952259595108,
                             ...
                             'right_s1': -0.9999781166910306}     #------------初始化关节角设置
    pnp = PickAndPlace(limb, hover_distance)                      #------------右臂 悬停距离=0.15m  
    ...
    #the position of female box                                  #---------------female box 位置！！
